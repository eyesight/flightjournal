...
class Logo extends Component {
    constructor(props) {
        ...
        this.suncloud.bind(this);
        this.isDay.bind(this);
        this.snowing.bind(this);
        this.lightnings.bind(this);
        this.fog.bind(this);
        this.sunfog.bind(this);
        this.sun.bind(this);
        this.rain.bind(this);
        this.cloud.bind(this);
    }
    ...
    isDay = (sunrise, sunset) =>{
        ...
        let sunsetTime = sunset ? (new Date(1000*sunset).getHours()) + 2 : 21; //When no time is given, take 6:00 pm;
   ...
   fog = () => {
    ...
    fogOnHover = () => {
        return new TimelineLite()
        .to(this.nebelWoke.current, 0.5, {y:'5px'})
        .to(this.nebel1.current, 0.5, {x:'3px'})
        .to(this.nebel1.current, 0.5, {x:'0px'})
        .to(this.nebel2.current, 0.5, {x:'3px'}, '-=0.5')
        .to(this.nebel2.current, 0.5, {x:'0px'})
        .to(this.nebel3.current, 0.5, {x:'3px'}, '-=0.1')
        .to(this.nebel3.current, 0.5, {x:'0px'})
        .to(this.nebel1.current, 0.5, {x:'3px'})
        .to(this.nebel1.current, 0.5, {x:'0px'})
        .to(this.nebel2.current, 0.5, {x:'3px'}, '-=0.5')
    ...
    rain = () => {
        ...
        r.fromTo(this.regen.current, 0.1, {opacity:0, y:'50px', x:'0px'}, {opacity:1, y:'0px'})
    ...
    cloud = (xval, cloud = this.wolke.current) => {
        return new TimelineLite()
        .fromTo(cloud, 0.5,
            {x: xval+'px',
                y:'50px',
    ...
    animation(ishover, weatherid){
        ...
        switch(weatherid){
           ...
           case 232:
                //animation thunder
                if(ishover){
                    tl2.add(this.lightnings());
                    tl2.delay(1).play();
                }else{
                    tl2.add(this.cloud(14), 0)
                    tl2.add(this.lightnings());
                    tl2.delay(1).play();
                }
                break
           case 801:
                ...
                if(ishover){
                    tl2.add(this.suncloudOnHover('+0.3'));
                    tl2.delay(0.2).play();
                }else{
                    tl2.add('sonnewolke');
                    tl2.add(this.cloud(ycloud), 'sonnewolke');
                    tl2.add(this.suncloud('sonnewolke+=0.3'));
                    tl2.delay(1).play();
                }
                break;
           case 800:
            ...
            case 781:
                //animation fog
                if(ishover){
                    tl2.add(this.fogOnHover());
                    tl2.play();
                }else{
                    tl2.add(this.cloud(14, this.nebelWoke.current), 0);
                    tl2.add(this.fog());
                    tl2.delay(1).play();
                }
                break
            ...
            default:
                ...
                tl2.add(this.cloud(ycloud), 'sonnewolkeschnee');
                tl2.add(this.suncloud('sonnewolkeschnee+=0.3'));
                tl2.add(this.snowing(3));
                tl2.delay(1).play();
                break;
        }
    }
    componentWillAppear (callback) {
       ...
       this.animation(false, weatherData.weather[0].id);
    } 

    handleMouseEnter(id){
        this.animation(true, id);
    }

    render() {
        return (
            <div className="logo__wrapper"> 
                <a className="logo__anchor" href={routes.HOME_ANCHOR_FLUGPLANUNG} onMouseEnter={()=>this.handleMouseEnter(this.state.weather)}>
